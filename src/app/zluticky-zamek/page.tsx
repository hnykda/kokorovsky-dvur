      ...
      <div className="max-w-5xl mx-auto px-5 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-12 lg:gap-16">
          ...
          <div className="lg:pt-2">
            <div className="bg-white rounded-2xl border border-primary/10 p-7 shadow-sm space-y-5">
              <h2 className="font-serif font-bold text-lg text-primary mb-1">
                Kontaktní údaje
              </h2>
              <div className="divide-y divide-primary/8 text-sm font-sans">
                ...
                <div className="py-4">
                  ...
                  <span className="inline-flex items-center gap-2">
                    ...
                    <span className="bg-accent/15 text-accent text-[10px] font-sans uppercase tracking-wider px-1.5 py-0.5 rounded font-semibold">
                      TODO
                    </span>
                  </span>
                </div>
                <div className="pt-4">
                  <a
                    ...
                    className="inline-flex items-center gap-2 bg-primary text-white font-sans text-sm font-medium px-4 py-2.5 rounded-lg hover:bg-primary-dark transition-colors duration-200"
                  >
                    <svg
                      width="16"
                      height="16"
